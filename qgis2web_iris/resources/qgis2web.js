...
map.getView().fit([-192043.522233, 5940013.882771, -166731.512903, 6015366.251603], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Cartographie des DPE majoritaires par IRIS à Nantes métropole</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (169 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'D\'après les données de la BDNB sur les DPE par bâtiments, les données sont regroupées par IRIS pour afficher le DPE majoritaire sur l\'ensemble de la métropole nantaise. ';
            }
