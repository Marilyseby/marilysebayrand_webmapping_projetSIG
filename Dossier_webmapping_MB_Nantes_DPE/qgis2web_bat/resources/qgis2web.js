...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Cartographie de l\'ancienneté des bâtiments de la métropole nantaise</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (128 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'D\'après les données de l\'IGN sur les bâtiments,cette cartographie montre l\'ancienneté des bâtiments par période de constuction. ';
            }
